...
<main>
    <section class="order-summary">
        ...
        <?php
        // 🧮 Backend calculation (initial PHP render)
        $items = [
        ...
        <form method="POST" action="">
            ...
            <div class="cart-item">
                ...
                <div style="text-align: right;">
                    ...
                    <?php endif; ?>
                    <div id="shoes-discount-percent" style="font-size:0.9rem;color:#4CAF50;">
                        Discount: <?= $items['shoes']['quantity'] >= 5 ? '10%' : '0%' ?>
                    </div>
                </div>
            </div>
            ...
            <div class="cart-item">
                ...
                <div style="text-align: right;">
                    ...
                    <?php endif; ?>
                    <div id="pants-discount-percent" style="font-size:0.9rem;color:#4CAF50;">
                        Discount: <?= $items['pants']['quantity'] >= 5 ? '10%' : '0%' ?>
                    </div>
                </div>
            </div>
            ...
            <div class="summary-section">
                ...
                <div class="summary-row total">
                    ...
                    <span id="grand-total">₱<?= number_format($bulkDiscount, 2) ?></span>
                </div>

                <div class="summary-row">
                    <span>VAT (12%):</span>
                    <span id="vat">-₱<?= number_format($vat, 2) ?></span>
                </div>

                <div class="summary-row total">
                    <strong>Net with VAT:</strong>
                    <strong id="final-total">₱<?= number_format($finalTotal, 2) ?></strong>
                </div>
            </div>
